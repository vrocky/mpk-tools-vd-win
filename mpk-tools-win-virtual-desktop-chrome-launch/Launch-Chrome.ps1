...
<#
.SYNOPSIS
    Opens Google Chrome with an isolated profile for the current virtual desktop.
    Profile dirs: C:\ChromeProfiles\virtual_desktop_[N]\

.EXAMPLE
    .\Launch-Chrome.ps1
    .\Launch-Chrome.ps1 -Desktop 3
    .\Launch-Chrome.ps1 -Url "https://github.com"
#>
param(
    [int]$Desktop = 0,
    [string]$Url  = ""
