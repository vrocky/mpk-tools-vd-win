...
using AntigravityProfileProjectSearch.Services;
using AntigravityProfileProjectSearch.Views;

namespace AntigravityProfileProjectSearch;
...
public partial class MainWindow : Window
{
    ...
    private async Task RefreshIndexAsync()
    {
        try
        {
            ...
            {
                var settings = AntigravitySettingsService.Load();
        ...
        catch (Exception ex)
        {
            ...
            StatusText.Text = "Error while scanning. See log file in %LocalAppData%\\AntigravityProfileProjectSearch\\logs.";
        }
    }
    ...
    private void OpenProject_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            var arguments =
                $"--user-data-dir \"{item.UserDataPath}\" --new-window \"{item.ProjectPath}\"";
